/**
 * @file ArduboyBase.h
 * \brief A class implementing the base Arduboy upon which to build an
 * application.
 * \details The ArduboyBase translation unit provides a more developed, but
 * light-weight object to be used in creating an application for an Arduboy.
 * This class contains no sound or character printer, please use the Arduboy
 * class if you wish to use sound or print text without the aid of external
 * libraries.
 */

#ifndef ARDUBOY_BASE_H
#define ARDUBOY_BASE_H
